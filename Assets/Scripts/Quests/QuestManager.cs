...
public class QuestManager : Singleton<QuestManager>
{
    ...
    public void ReclamarRecompensa()
    {
        ...
        personaje.PersonajeExperiencia.AñdirExperiencia(QuestPorReclamar.RecompensaExp);
    ...
    {
        Quest quesPorActualizar = QuestExiste(questID);
        quesPorActualizar.AñadirProgreso(cantidad);
    }
    ...
    private void QuesCompletadoRespuesta(Quest questCompletado)
    {
    ...
    {
        Quest.EventoQuestCompletado += QuesCompletadoRespuesta;
    }
